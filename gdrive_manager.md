...
스킬 경로: ~/Documents/github_skills/gdrive_manager
...
### 드라이브 목록
```bash
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --list-drives
```

### 드라이브 추가
```bash
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --add-drive --alias 별칭 --folder-id 폴더ID
```

### 폴더 내용 조회
```bash
# 루트 조회
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --list --drive 꽃킬커머스

# 하위 폴더 조회
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --list --drive 꽃킬커머스 --folder 300
```

### 파일 검색
```bash
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --search --drive 꽃킬커머스 --query 파일명
```

### 인덱스 아키텍처 보기
```bash
cd ~/Documents/github_skills/gdrive_manager && python3 gdrive_manager.py --index
```
